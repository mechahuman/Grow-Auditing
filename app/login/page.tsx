...
import growLogo from '../../public/image.png'
          ...
          <div className="text-center mb-12">
            ...
            <div className="relative mx-auto mb-3 w-fit">
              ...
              <div
                ...
                style={{
                  inset: '-10px',
                  background: 'radial-gradient(ellipse at center, rgba(139, 92, 246, 0.8) 0%, rgba(109, 40, 217, 0.35) 60%, transparent 85%)',
                  filter: 'blur(20px)',
                  zIndex: 0,
                }}
              />
              ...
              <img
                src={growLogo.src}
                alt="GetRichOn Wednesday"
                width={280}
                style={{ zIndex: 1, position: 'relative', borderRadius: '12px' }}
              />
            </div>
